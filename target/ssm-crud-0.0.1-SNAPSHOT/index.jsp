	...
	<script type="text/javascript">
		...
		function build_page_info(result) {
			...
			$("#page_info_area").append(
					"当前<kbd>" + result.extend.pageInfo.pageNum + "</kbd>页,总<kbd>"
							+ result.extend.pageInfo.pages + "</kbd>页,总<kbd>"
							+ result.extend.pageInfo.total + "</kbd>条记录");
		...
		function validate_add_form() {
			...
			if ($("#user").text() == "用户名不可用") {
				...
				//alert("用户名可以是2-4位中文或者6-16位英文和数字的组合");
